...
export default function WorkspaceShell({ children }) {
  ...
  const links = user?.rol === 'Cliente'
    ...
    : user?.rol === 'Entrenador'
      ...
      : [['/admin/dashboard','Dashboard'],['/admin/usuarios','Usuarios'],['/admin/planes','Planes'],['/recepcion/clientes','Clientes'],['/recepcion/pagos','Pagos'],['/admin/rutinas','Catálogo'],['/admin/asignaciones','Asignaciones'],['/admin/reportes','Reportes'],['/admin/configuracion','Configuración']];
